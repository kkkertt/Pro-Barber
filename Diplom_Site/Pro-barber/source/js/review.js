document.addEventListener('DOMContentLoaded', function () {
	...
	addReviewBtn.addEventListener('click', function () {
			const nameInput = modal.querySelector('.modal__input[placeholder="Ваше имя"]').value.trim();
			const textInput = modal.querySelector('.modal__input[placeholder="Текст отзыва"]').value.trim();
